        ...
        try
        {
            ...
            db.query("SELECT * FROM config WHERE guild = ?", [guild.id], async (err, config) =>
            {
                ...
                else
                {
                    ...
                    .addFields([{ name: ":no_entry:・Anti swear:", value: "➜ :red_circle: Prevent the members from **using bad words** by warning them. After **the maximum configured amount of warns** reached, the member will **receive a sanction**." }])
